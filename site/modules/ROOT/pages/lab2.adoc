...
* **The lab notebook** builds aircraft topology (20 aircraft, 80 systems, 320 components), then adds sensors, flights, delays, and maintenance events
