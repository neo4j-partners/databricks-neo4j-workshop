...
Open `Lab_4_Compound_AI_Agents/04_genie_agent.ipynb` to build your Genie space, and keep the space ID it gives you. Lab 5 reads it as `GENIE_SPACE_ID`, and losing it means rebuilding the space.
