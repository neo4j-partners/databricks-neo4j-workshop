"""Automated validation of Lab 3 Notebook 02: GraphRAG Retrievers.

Read-only validation that the KG built by notebook 01 supports the retriever
patterns from 02_graphrag_retrievers.ipynb: VectorRetriever, GraphRAG,
...
Prerequisite: run_lab3_01.py must have been run first (KG + indexes exist).

Usage:
    ./upload.sh --all && ./submit.sh run_lab3_02.py
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Lab 3 Validation: GraphRAG Retrievers (Notebook 02)"
    )
    ...
    print("=" * 70)
    print("Lab 3 Validation: GraphRAG Retrievers (Notebook 02)")
    print("=" * 70)
