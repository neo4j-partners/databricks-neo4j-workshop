...
> **Prerequisite:** This query only works after notebook [`02_gds_knn_aircraft.ipynb`](02_gds_knn_aircraft.ipynb) has run, since that notebook creates the `SIMILAR_PROFILE` relationships.
