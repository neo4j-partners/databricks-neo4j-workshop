...
Slides for this lab: xref:slides/slides-graphrag-foundations.adoc[GraphRAG Foundations] and xref:slides/slides-retriever-patterns.adoc[GraphRAG Retriever Patterns].
